import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, Z as Zap, u as useNavigate, I as Input, B as Button, U as User } from "./index-BZ7Eu0u-.js";
import { L as Label, T as Textarea } from "./textarea-Dw0gXcO9.js";
import { d as useRegisterNGO, e as useRegisterVolunteer, M as MapPin } from "./useAidLink-PClPnHG1.js";
import { u as ue } from "./index-B3ih9tsb.js";
import { C as CircleCheck } from "./circle-check-hFigbP3B.js";
import { E as EyeOff, a as Eye, L as Lock } from "./lock-DoiOc_CK.js";
...
function SignUpForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const raw = err instanceof Error ? err.message : typeof err === "string" ? err : "Registration failed. Please try again.";
      const match = raw.match(/(?:Canister called|Error:\s*)(.+?)(?:\s*\(|$)/i);
      const msg = ((_a = match == null ? void 0 : match[1]) == null ? void 0 : _a.trim()) ?? raw;
      const isKnown = msg.toLowerCase().includes("already registered") || msg.toLowerCase().includes("duplicate") || msg.toLowerCase().includes("already exists");
      ue.error(
        isKnown ? `That ${role === "ngo" ? "organization name or email" : "name"} is already registered. Try a different one.` : msg.length < 200 ? msg : "Registration failed. Please try again."
      );
    }
  };
  if (success) {
