import { c as createLucideIcon, r as reactExports, o as reactDomExports, j as jsxRuntimeExports, P as Primitive, g as useComposedRefs, f as createContextScope, i as useCallbackRef, p as useLayoutEffect2, h as useControllableState, d as useId, e as composeEventHandlers, q as Portal$1, s as hideOthers, t as useFocusGuards, v as ReactRemoveScroll, F as FocusScope, w as DismissableLayer, x as createSlot, b as cn, B as Button, L as Link, Z as Zap, S as Send, I as Input, M as Minus } from "./index-BZ7Eu0u-.js";
import { L as Label, T as Textarea } from "./textarea-Dw0gXcO9.js";
import { u as useDirection, c as createCollection, P as Plus, H as House, B as BookOpen } from "./index-uiZ5bCPK.js";
import { u as useSize, a as usePrevious } from "./index-BR_EKtfA.js";
import { C as ChevronDown } from "./chevron-down-B8L5xDdJ.js";
import { C as ChevronUp } from "./chevron-up-CrpwcA5N.js";
import { k as useCreateRequest, a as useNGOs, U as Urgency, j as ResourceType, M as MapPin, s as stringToUrgency, l as stringToResourceType } from "./useAidLink-PClPnHG1.js";
import { u as ue } from "./index-B3ih9tsb.js";
import { C as CircleCheck } from "./circle-check-hFigbP3B.js";
import { C as Clock } from "./clock-D64rBOwV.js";
...
function ResourceIcon({
  ...
  if (type === ResourceType.food) return /* @__PURE__ */ jsxRuntimeExports.jsx(Utensils, { ...props });
  if (type === ResourceType.shelter) return /* @__PURE__ */ jsxRuntimeExports.jsx(House, { ...props });
  if (type === ResourceType.medical) return /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { ...props });
  if (type === ResourceType.education) return /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { ...props });
  if (type === "water") return /* @__PURE__ */ jsxRuntimeExports.jsx(Droplets, { ...props });
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Package, { ...props });
}
function useStepTransition(step) {
  const [display, setDisplay] = reactExports.useState(step);
  const [animClass, setAnimClass] = reactExports.useState("opacity-100 translate-x-0");
  const prev = reactExports.useRef(step);
  reactExports.useEffect(() => {
...
function ProgressBar({ step }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", "data-ocid": "request.progress", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-between mb-4", children: STEPS.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center flex-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              background: step >= s.id ? "linear-gradient(135deg, oklch(0.65 0.24 262), oklch(0.68 0.23 290))" : "rgba(255,255,255,0.06)",
              border: step >= s.id ? "1px solid oklch(0.72 0.27 262 / 0.6)" : "1px solid rgba(255,255,255,0.12)",
              boxShadow: step >= s.id ? "0 0 16px rgba(104,174,255,0.5)" : "none",
              color: step >= s.id ? "#fff" : "oklch(0.65 0.02 260)"
            },
            children: step > s.id ? /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-4 h-4" }) : s.id
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            ...
            style: {
              color: step >= s.id ? "oklch(0.85 0.1 262)" : "oklch(0.55 0.02 260)"
            },
            children: s.label
          }
        )
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                ...
                background: "linear-gradient(90deg, oklch(0.65 0.24 262), oklch(0.68 0.23 290))",
      ...
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              width: `${pct}%`,
              background: "linear-gradient(90deg, oklch(0.65 0.24 262), oklch(0.68 0.23 290), oklch(0.75 0.25 270))",
...
function RequestFormPage() {
  ...
  const clearError = (key) => setErrors((p) => {
    const n = { ...p };
    delete n[key];
    return n;
  });
  ...
  async function handleSubmit() {
    ...
    try {
      const deadlineTs = form.deadline ? BigInt(new Date(form.deadline).getTime()) * BigInt(1e6) : BigInt(Date.now() + 7 * 24 * 60 * 60 * 1e3) * BigInt(1e6);
      const effectiveResourceType = form.resourceType === "water" ? ResourceType.other : form.resourceType;
      await createRequest({
        title: form.title,
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            style: {
              ...
              boxShadow: "0 0 32px rgba(52,211,153,0.15), 0 8px 32px rgba(0,0,0,0.4)"
            },
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-3xl text-foreground mb-3", children: "Request Submitted!" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground mb-2 text-base", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mb-8", children: "Our AI will match you with the best available volunteers shortly." }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    ...
                    style: {
                      background: "linear-gradient(135deg, oklch(0.65 0.24 262), oklch(0.68 0.23 290))",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/ngo", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    type: "button",
                    variant: "outline",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  style: {
                    background: "radial-gradient(circle, oklch(0.65 0.24 262 / 0.12), transparent 70%)",
                    filter: "blur(60px)"
                  }
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  style: {
                    background: "radial-gradient(circle, oklch(0.75 0.25 290 / 0.1), transparent 70%)",
                    filter: "blur(50px)"
                  }
                }
              )
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 container mx-auto max-w-2xl", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-10", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "h1",
              {
                ...
                style: {
                  background: "linear-gradient(135deg, #fff 30%, oklch(0.75 0.25 270))",
                  WebkitBackgroundClip: "text",
                  WebkitTextFillColor: "transparent",
                  backgroundClip: "text"
                },
                children: "Create Resource Request"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-lg", children: "Our AI matches your request with the best available volunteers" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `transition-all duration-200 ease-out ${animClass}`, children: [
                  displayStep === 1 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Step1,
                    {
                      form,
                      errors,
                  ...
                  displayStep === 2 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Step2,
                    {
                      form,
                      errors,
                  ...
                  displayStep === 3 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Step3,
                    {
                      form,
                      errors,
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2", children: STEPS.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          className: "w-2 h-2 rounded-full transition-all duration-300",
                          style: {
                            background: step >= s.id ? "linear-gradient(135deg, oklch(0.65 0.24 262), oklch(0.68 0.23 290))" : "rgba(255,255,255,0.15)",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-center gap-8 mt-8 text-sm text-muted-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Link,
              {
                to: "/ngo",
...
function Step1({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-semibold text-xl text-foreground mb-1", children: "Basic Information" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "Tell us about your request" })
    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-sm font-medium text-muted-foreground", children: "Organization *" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Select,
        {
          value: form.ngoId,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              SelectTrigger,
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  SelectValue,
                  {
                    placeholder: ngosLoading ? "Loading NGOs..." : ngos.length === 0 ? "No NGOs registered yet" : "Select your organization..."
                  }
                )
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: ngosLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "__loading", disabled: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-3 h-3 rounded-full border border-current border-t-transparent animate-spin inline-block" }),
              "Loading NGOs…"
            ] }) }) : ngos.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "__none", disabled: true, children: "No NGOs available. Register one first." }) : ngos.map((ngo) => /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectItem, { value: ngo.id.toString(), children: [
              ngo.name,
              ngo.isVerified ? " ✓" : ""
            ] }, ngo.id.toString())) })
          ]
      ...
      errors.ngoId && /* @__PURE__ */ jsxRuntimeExports.jsx(
        "p",
        {
          className: "text-xs text-red-400",
          "data-ocid": "request.ngo.field_error",
          children: errors.ngoId
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-sm font-medium text-muted-foreground", children: "Urgency Level *" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: "grid grid-cols-2 gap-3",
          "data-ocid": "request.urgency.cards",
          children: URGENCY_OPTIONS.map((opt) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                className: `relative p-4 rounded-2xl text-left transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary ${isSelected ? `${opt.bgActive} ${opt.borderActive}` : "border-border"}`,
                style: {
                  background: isSelected ? void 0 : "rgba(255,255,255,0.03)",
                  border: "1px solid",
                  borderColor: isSelected ? void 0 : "rgba(255,255,255,0.08)",
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl mb-2 block", children: opt.icon }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
      ...
      errors.urgency && /* @__PURE__ */ jsxRuntimeExports.jsx(
        "p",
        {
          className: "text-xs text-red-400",
...
function Step2({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-semibold text-xl text-foreground mb-1", children: "Resource Details" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "Specify what resources you need" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-sm font-medium text-muted-foreground", children: "Resource Type *" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: "grid grid-cols-3 gap-3",
          "data-ocid": "request.resource_type.cards",
          children: RESOURCE_OPTIONS.map((opt) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                style: {
                  ...
                  boxShadow: isSelected ? "0 0 20px rgba(104,174,255,0.25)" : "none"
                },
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      className: `w-10 h-10 rounded-xl flex items-center justify-center transition-all duration-200 ${isSelected ? `${opt.bgActive} ${opt.iconColor}` : "bg-muted/30 text-muted-foreground"}`,
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResourceIcon, { type: opt.value, className: "w-5 h-5" })
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      className: `text-xs font-medium transition-colors duration-200 ${isSelected ? opt.iconColor : "text-muted-foreground"}`,
                      children: opt.label
                    }
                  )
                ]
      ...
      errors.resourceType && /* @__PURE__ */ jsxRuntimeExports.jsx(
        "p",
        {
          className: "text-xs text-red-400",
          "data-ocid": "request.resource_type.field_error",
          children: errors.resourceType
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          {
            id: "req-unit",
            placeholder: (selectedRes == null ? void 0 : selectedRes.unit) ?? "e.g. kg, beds, kits",
            value: form.unit,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Label,
        {
          ...
          children: [
            "Additional Notes",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-2 text-xs opacity-60", children: "(optional)" })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
...
function Step3({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-semibold text-xl text-foreground mb-1", children: "Location & Timeline" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "Where and when is this resource needed?" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Label,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-sm font-medium text-muted-foreground", children: "Coordinates" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "36", height: "36", viewBox: "0 0 36 36", "aria-hidden": "true", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "circle",
                {
                  cx: "18",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "18", cy: "18", r: "4", fill: "oklch(0.65 0.24 262)" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "circle",
                {
                  cx: "18",
      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2 text-xs", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SummaryRow, { label: "Title", value: form.title || "—" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(SummaryRow, { label: "Organization", value: (selectedNGO == null ? void 0 : selectedNGO.name) ?? "—" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(SummaryRow, { label: "Resource", value: (selectedResource == null ? void 0 : selectedResource.label) ?? "—" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              SummaryRow,
              {
                label: "Urgency",
                value: (selectedUrgency == null ? void 0 : selectedUrgency.label) ?? "—",
                valueClass: selectedUrgency == null ? void 0 : selectedUrgency.colorClass
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              SummaryRow,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(SummaryRow, { label: "Location", value: form.city || "—" })
          ] })
        ]
      }
    )
